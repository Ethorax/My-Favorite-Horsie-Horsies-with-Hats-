...
@onready var fl_leg = $Armature/FLIKTarget
@onready var fr_leg = $Armature/FRIKTarget

@onready var bl_leg = $Armature/BLIKTarget
@onready var br_leg = $Armature/BRIKTarget
